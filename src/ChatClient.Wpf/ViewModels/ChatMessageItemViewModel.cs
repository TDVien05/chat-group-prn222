...
public sealed class ChatMessageItemViewModel
{
    ...
    public static ChatMessageItemViewModel FromMessage(ChatMessage message, string currentUser)
    {
        ...
        return new ChatMessageItemViewModel
        {
            ...
            BubbleBrush = ResolveBubbleBrush(isSystem, isOwn, isFileReady),
            ...
            Alignment = isSystem || isFileProgress ? HorizontalAlignment.Center : (isOwn ? HorizontalAlignment.Right : HorizontalAlignment.Left),
    ...
    private static Brush ResolveBubbleBrush(bool isSystem, bool isOwn, bool isFileReady)
    {
